...
while continuar.lower() == "sim":
    total_pedidos += 1
    print(f"/n ---- Pedido {total_pedidos} ----")
    ...
    for i in range(1, itens_pedido + 1):
        nome = input(f"Digite o nome do {i}o item: ")
...
print(f"Clientes que compraram mais de 3 itens: {clientes_acima_3_itens}")